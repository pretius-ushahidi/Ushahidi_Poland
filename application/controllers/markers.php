...
class Markers_Controller extends Template_Controller
{
	...
	{		
		...
		{
			$filter = 'incident.incident_active = 1 AND incident.incident_archived = 0 AND incident_category.category_id = ' . $category_id;
			$filter_cat = 'category_visible = 1 AND id = ' . $category_id;
		}
		else
		{
			$filter = 'incident.incident_active = 1 AND incident.incident_archived = 0 ';
