				...
				<div id="content">
					<div class="content-bg">
						...
						<div class="big-block">
                            ...
                            <!-- Mobile Alert -->
                            <!-- /*
                            We've switched mobile alerts off
							<div class="green-box">
								<?php
								if ($alert_mobile)
								{
...
?>
									...
									<div class="alert_confirm">
										...
										<?php 
										print form::open('/alerts/verify');
										print "Kod weryfikacyjny:<BR>".form::input('alert_code', '', ' class="text"')."<BR>";
										print "Twój Email:<BR>".form::input('alert_email', $alert_email, ' class="text"')."<BR>";
										print form::submit('button', 'Potwierdź moje notyfikacje', ' class="btn_submit"');
										print form::close();
										?>
                                    </div>
                                    */-->
