...
?>
			<div class="bg">
				<h2><?php echo $title; ?> <span>(<?php echo $total_items; ?>)</span><a href="<?php print url::site() ?>admin/reports/edit"><?php echo Kohana::lang('ui_main.create_report');?></a><a href="<?php print url::site() ?>admin/reports/download"><?php echo Kohana::lang('ui_main.download_reports');?></a><a href="<?php print url::site() ?>admin/reports/upload"><?php echo Kohana::lang('ui_main.upload_reports');?></a><a href="<?php print url::site() ?>admin/reports/notify"><?php echo Kohana::lang('ui_main.notify_reports');?></a></h2>
				<!-- tabs -->
				<div class="tabs">
					<!-- tabset -->
					<ul class="tabset">
					...
					<div class="tab">
						<ul>
							...
							<li><a href="#" onclick="reportAction('r','ARCHIVE', '');"><?php echo Kohana::lang('ui_main.archive');?></a></li>
								...
								foreach ($incidents as $incident)
								{
									...
									<tr>
										...
										<td class="col-2">
											...
											<ul class="info">
												<li class="none-separator">ID: <strong><?php echo $incident_id; ?></strong></li>
										...
										<td class="col-4">
											<ul>
												...
												<li><a href="#" onclick="reportAction('r','ARCHIVE', '<?php echo $incident_id; ?>');"><?php echo Kohana::lang('ui_main.archive');?></a></li>
