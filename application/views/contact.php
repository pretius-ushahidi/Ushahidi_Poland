					...
					<div class="content-bg">
						...
						<div class="big-block">
							...
							<div id="contact_us" class="contact">
								...
								<div class="report_row">
									<strong>Kod bezpieczeństwa (aby zapobiedz SPAMowi):</strong><br />
									<?php print $captcha->render(); ?><br />
									<?php print form::input('captcha', $form['captcha'], ' class="text"'); ?>
								</div>
								<div class="report_row">
									<input name="submit" type="submit" value="Wyślij wiadomość" class="btn_submit" />
								</div>
