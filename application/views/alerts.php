						...
						<div class="big-block">
							...
							<div class="step-1">
								...
								<div class="report-find-location">
									...
									<div style="float:left;margin:9px 0 0 5px;"><input type="button" name="button" id="button" value="Znajdź lokalizację" class="btn_find" /></div>
									<div id="find_loading" class="report-find-loading"></div>
									<div style="clear:both;" id="find_text">* Jeżeli nie możesz odnaleźć lokalizacji, proszę odszukaj ją na mapie i oznacz przez kliknięcie.</div>
								</div>
							</div>
